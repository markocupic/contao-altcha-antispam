...
$GLOBALS['TL_LANG']['ERR']['altcha_hmac_key_not_found'] = 'Der ALTCHA hmac key ist noh leer und muss konfiguriert werden. Bitte fügen Sie diesen in config/config.yaml hinzu. <a href="https://github.com/markocupic/contao-altcha-antispam?tab=readme-ov-file#configuration-and-usage" target="_blank">Mehr</a>';
