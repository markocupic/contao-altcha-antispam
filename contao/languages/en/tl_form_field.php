...
$GLOBALS['TL_LANG']['tl_form_field']['altchaNoErrorLog'] = ['disable error logging', 'Disable error logging for this ALTCHA widget. This is useful if you want to prevent repeated failed attempts by bots from flooding your error log.'];
